...
abstract contract UnorderedNonce {
  ...
  /// @notice A map from commitmentHash and a caller specified word index to a bitmap. Used to set bits in the bitmap to prevent against signature replay protection
